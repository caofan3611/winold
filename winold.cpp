...
ll winold::createVid(string name_, vidtype thing_) {
    return createVid(name_, 0, thing_);
}
ll winold::createVid(string name_) {
    return createVid(name_, winold::nullvid);
}
...
ll winold::replaceVid(string name_, winold::vidtype thing_) {
    return replaceVid(name_,0,thing_);
}
...
ll winold::playVid(ll l,ll times) {
    ...
    for(int for_frame = 0; for_frame < vids[l].thing.size(); for_frame++) {
       // if(frame_iter != vids[l].color.end() && frame_iter->first == for_frame) {
...
ll winold::playVid(string s,ll times) {
    ...
    return playVid(getVidIndex(s),times);
    //return 0;
}
...
ll winold::setVidFrameColor(string name_,ll frame_,ll color_,vector<ll> range_){
    ...
    {
        iserr=iserr_copy;
        return setVidFrameColor(ind,frame_,color_,range_);
       // return 0;
    };
    //return 0;
}
...
ll winold::setVidFrameColor(string name_,ll frame_,ll color_,ll start_,ll end_){
    ...
    }else
    {
        ...
        if(start_==0&&end_==0)
        {
            ...
            return setVidFrameColor(name_,frame_,color_,vseter);
           // return 0;
...
ll winold::setVidFrameColor(ll index_,ll frame_,ll color_,ll start_,ll end_){
    ...
    {
        iserr=iserr_copy;
       return setVidFrameColor(ind,frame_,color_,start_,end_);
        //return 0;
    };
}

void winold::hideCursor(){
    cout << "\033[?25l"<< std::flush;
}

void winold::showCursor(){
