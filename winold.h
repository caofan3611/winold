...
public:
  ...
  void clearScreen();
  ll setVidFrameColor(string name_,ll frame_,ll color_,ll start_=0,ll end_=0);
  ll setVidFrameColor(ll index_,ll frame_,ll color_,ll start_=0,ll end_=0);
  ...
  ll getVidIndex(string s);
   ...
   void clearVid();
   ll removeVid(ll l);
   typedef vector<std::wstring> vidtype;
